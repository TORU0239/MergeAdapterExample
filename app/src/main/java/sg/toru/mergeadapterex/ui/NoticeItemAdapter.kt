...
class NoticeItemAdapter():ListAdapter<String, NoticeItemViewHolder>(NoticeItemDiffCallback()) {
...
class NoticeItemViewHolder(private val binding: ItemNoticeLayoutBinding):RecyclerView.ViewHolder(binding.root) {
